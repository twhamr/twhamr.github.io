...
<section
  ...
  data-taxonomy-page
  data-page-size="6"
  data-item-label="project"
  data-item-label-plural="projects"
>
  <header class="taxonomy-header">
    <h1>{{ page.title }}</h1>
    <p class="taxonomy-intro">
      A collection of projects, labs, and builds focused on networking, software development, and cybersecurity.
    </p>
  </header>
  ...
  <div class="taxonomy-list" data-taxonomy-list>
    {% for project in site.projects %}
      <article class="taxonomy-card" data-terms='{{ project.skills | jsonify }}'>
        <div class="taxonomy-meta">
          ...
          {% if project.skills and project.skills.size > 0 %}
        ...
        <a class="taxonomy-link" href="{{ project.url | relative_url }}">
          View project →
        </a>
      </article>
    {% endfor %}
